        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="items-center pr-2 sm:ml-6 sm:pr-0">
            <div className="flex space-x-4 relative">
              ...
              <a href="/portfolio/resume.pdf" target="_blank" className="absolute -top-6 right-0 sm:static text-center rounded-md w-36 px-3 py-2 text-xl font-medium text-primary hover:bg-gray-800 hover:text-primary-hover border-2 border-primary hover:border-primary-hover">
